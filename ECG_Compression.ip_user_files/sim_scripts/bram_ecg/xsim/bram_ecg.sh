...
#
# Script generated by Vivado on Wed Feb 18 12:46:40 +0000 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_ecg.sh
...
#
# Usage        : bram_ecg.sh
#                bram_ecg.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_ecg.sh [-reset_run]
#                bram_ecg.sh [-reset_log]
#                bram_ecg.sh [-help]
#
...
export RDI_DATADIR="C:/Apps/Vivado/2024.2/data"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "bram_ecg.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_ecg.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot bram_ecg xil_defaultlib.bram_ecg -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_ecg -key {Behavioral:sim_1:Functional:bram_ecg} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Apps/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_ecg.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_ecg.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_ecg.sh [-help]\n\
Usage: bram_ecg.sh [-step]\n\
Usage: bram_ecg.sh [-lib_map_path]\n\
Usage: bram_ecg.sh [-reset_run]\n\
Usage: bram_ecg.sh [-reset_log]\n\
Usage: bram_ecg.sh [-keep_index]\n\
Usage: bram_ecg.sh [-noclean_files]\n\n\
