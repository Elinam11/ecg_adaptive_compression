...
#                script (type 'bram_ecg.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/elina/CapstoneVHDL/ECG_Compression/ECG_Compression.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
